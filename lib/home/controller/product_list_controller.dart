...
class ProductListController extends GetxController {
  ...
  String? id;
  ProductListController(this.id);
  late SubCatController subCatController;
  ...
  @override
  void onInit() {
    subCatController = Get.find<SubCatController>();
  ...
  void filterByCategory() {
    ...
    for (var hotel in subCatController.list2.value) {
