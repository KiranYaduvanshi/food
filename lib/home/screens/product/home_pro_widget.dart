...
import 'package:food_user/home/controller/home_pro_widget.controller.dart';
...
Widget HomeProListWidget(List<dynamic> list, int index) {
  HomeProductwidgetController controller =
      Get.put(HomeProductwidgetController(index), tag: "$index");
